...
# 阿旺一早出海，船停在港外深處——回港不是一步跨上岸，得沿著航道走一段。
GRID_ROWS = [
    "############################",
    "#aaa......bbbb......cccc...#",
    "#aaa......bbbb......cccc...#",
...
AREAS = [
    ...
    Area("外海漁船", 15, 15, 26, 27,
         "港外遠處的漁船與回港航道。一早出海的人要沿著航道走好一段才靠得了岸；"
         "水閘一焊死就回不了港，亥時一到海不留人。"),
]
...
- **外海漁船**：阿旺一早出海，船還在港外遠處，回港要走一段航道；水閘一焊死就進不來。
- **廣場**：消息與恐慌都從這裡擴散。
...
你一早就出海捕魚，船還停在港外遠處。潮色不對了，你得趕緊往回走——
可回港不是一步跨上岸，航道要走好一段，岸上的人再急也幫不了你縮短海路。
門一焊死，這條船就進不去；亥時一到，外海一樣會吞人。

你能看潮。別在船上發呆——沿著航道往漁港趕，上岸找阿海。他一定在為你拼命，
你也得自己把命跑回來。""",
    },
    {
        "id": "qing_he",
