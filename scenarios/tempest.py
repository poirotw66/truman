...
情況：你是祭司，潮訊已緊，鎮廟裡只有你一個人。
  ...
  action: speak / target_agent=林美華 / utterance=村長，帶兩個人上廟，我現在就開禮。
...
情況：你是村長，廣場上有人發慌想往海堤看熱鬧。
  ...
  action: use_art / art=號令 / target_agent=阿海 / utterance=你先去漁港收船，收完上廟觀禮。
"""
...
封晚了，鎮潮禮也擋不住灌進來的水。你跑得動，別浪費在廣場站著聽人哭。""",
    },
    {
        ...
        "goals": [
            {"kind": "meet", "text": "當面把陳金水說動／對上話，確認開禮",
             "params": {"who": "shen_xi"}},
            {"kind": "meet", "text": "當面把張鐵雄說動／對上話，確認封閘",
             "params": {"who": "shi_lei"}},
...
你腿快，也能望潮打聽誰在哪。收完船，去跟阿德對一下潮訊——他看海堤，你看船路。""",
    },
    {
        "id": "qing_he",
        "name": "黃秀英",
...
你今天要自己先上高地站住，並找到村長林美華，把「誰先撤、誰去觀禮」說清楚。
    ...
    },
    {
        ...
        "goals": [
            {"kind": "reach", "text": "守在海堤，確認閘還能不能封",
             "params": {"area": "海堤"}},
            {"kind": "meet", "text": "找到張鐵雄，讓他來封閘",
             "params": {"who": "shi_lei"}},
        ],
        "persona": """\
你叫阿德，守望人，四十五歲，常年蹲在海堤看雲色與潮聲。大家都只叫你阿德。
你今天的工作是守住海堤視線，並把張鐵雄找回來封閘——你焊不動閘，但你跑得過風。
