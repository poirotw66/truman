...
AREAS = [
    ...
    Area("外海漁船", 20, 15, 25, 15,
         "還停在外海的漁船甲板。水閘一焊死，這條船就回不了港；亥時一到，海不留人。"),
]
...
- 阿旺，漁民，二十七歲。今早還在外海收網，暴潮前必須趕在水閘焊死前回港。
...
今早你還在外海收網，船停在港外。潮色不對了。你知道自己必須在水閘焊死前回港：
門一封，這條船就進不去；亥時一到，外海一樣會吞人。

你腿快，也能看潮。別在船上發呆——往漁港跑，找阿海。他一定在為你拼命，
你也得自己把命跑回來。""",
    },
    {
        "id": "qing_he",
